...
export default function ConcreteCalculator() {
  ...
  // 项目类型配置
  const projectTypes = {
    rectangular: { name: 'Rectangular', icon: Square, description: 'Standard rectangular slab' },
    driveway: { name: 'Driveway', icon: Square, description: 'Concrete driveway' },
    foundation: { name: 'Foundation', icon: Building, description: 'Building foundation' },
    floor: { name: 'Floor', icon: Home, description: 'Concrete floor' },
    column: { name: 'Column', icon: Columns, description: 'Cylindrical column' },
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          ...
          {Object.entries(projectTypes).map(([key, config]) => {
            ...
            return (
              <button
                ...
                className={`p-3 rounded-lg border-2 transition-all duration-200 flex flex-col items-center space-y-1 text-sm ${
                  projectType === key
      ...
      <div className="flex gap-3 mb-6">
        ...
        <button
          onClick={resetForm}
          className="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center"
        >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
              <div className="text-sm text-blue-600 dark:text-blue-400 font-medium">Volume</div>
