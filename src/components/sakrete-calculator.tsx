 ...
 */
export default function SakreteCalculator() {
  ...
  const exportResult = () => {
    ...
    const data = `Sakrete Calculator Results\n\n` +
    ...
    a.href = url;
    a.download = 'sakrete-calculator-results.txt';
  ...
  const primaryBagCount = result ? result.bags80lb : 0;
  const primaryBagUnit = 'bags';
  const primaryBagLabel = 'Using 80-lb Sakrete bags';
            ...
            {result ? (
              <div>
                ...
                <div className="px-5 py-4">
                  <div className="text-sm text-muted-foreground mb-1">Estimated Bags Needed</div>
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-4xl font-bold text-primary">{primaryBagCount.toLocaleString()}</span>
                    <span className="text-xl font-semibold text-primary">{primaryBagUnit}</span>
                  </div>
                  <div className="text-xs text-muted-foreground mt-1">{primaryBagLabel}</div>
                </div>
                ...
                <div className="px-5 border-t border-border divide-y divide-border">
                  ...
                  <ResultRow icon={<Package className="h-4 w-4" />} label="Volume" value={`${primaryVolume.toLocaleString()} ${primaryVolumeUnit}`} />
              ...
              <div className="px-5 py-12 text-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Enter valid dimensions and a unit price to see your estimate.
                </p>
              </div>
            )}
            </div>
